...
namespace SDLFramework {
	...
	inline bool ColliderVsColliderCheck(Collider* collider1, Collider* collider2) {
		...
		else if (collider2->GetType() == Collider::ColliderType::Box &&
			collider1->GetType() == Collider::ColliderType::Circle) {
